...
function StyleGuide() {
  return (
    <div className="style-guide">
      ...
      <div>
        <p>
          <abbr>Whereas disregard and contempt for human rights have resulted</abbr>
        </p>
      </div>
      <div>
      ...
      <nav>Whereas disregard and contempt for human rights have resulted</nav>
      <select>
        <option>1</option>
        <option>2</option>
        <option>3</option>
